...
export const sourcesVSCode: ThemeSource[] = [
  ...
  },
  {
    ...
    source:
      'https://github.com/marqu3ss/Aurora-X/blob/master/themes/Aurora%20X-color-theme.json',
  },
  {
    name: 'ayu-dark',
  ...
  },
  {
    ...
    source:
      'https://github.com/Jaredk3nt/laserwave/blob/master/themes/LaserWave-color-theme.json',
    type: 'dark',
  },
  {
    name: 'light-plus',
  ...
  },
  {
    ...
    patch: (theme) => {
      const globalSetting = theme.tokenColors.find(
        (i: any) => !i.scope && i.settings.background === '#011627',
      )
      if (globalSetting)
  ...
  },
  {
    ...
    displayName: 'Red',
    source:
      'https://github.com/microsoft/vscode/blob/main/extensions/theme-red/themes/Red-color-theme.json',
  },
  {
    name: 'solarized-dark',
...
export const sourcesCommunity: ThemeSource[] = [
  ...
  },
  {
    ...
    source:
      'https://github.com/metapho-re/kanagawa-vscode-theme/blob/main/themes/kanagawa-dragon-color-theme.json',
  },
  {
    name: 'kanagawa-lotus',
    source:
      'https://github.com/metapho-re/kanagawa-vscode-theme/blob/main/themes/kanagawa-lotus-color-theme.json',
    type: 'light',
  },
  {
    name: 'kanagawa-wave',
    source:
      'https://github.com/metapho-re/kanagawa-vscode-theme/blob/main/themes/kanagawa-wave-color-theme.json',
  },
  {
    name: 'min-dark',
    source:
  ...
  },
  {
    ...
    source:
      'https://github.com/loilo/vscode-snazzy-light/blob/master/themes/Snazzy-Light-color-theme.json',
    type: 'light',
  },
  {
    name: 'vesper',
  ...
  return themes.map((theme): ThemeSource => {
    const name = Array.isArray(theme)
      ...
      : theme
          ...
          .trim()
          .replace(/\s+/g, '-')
    const themeName = Array.isArray(theme) ? theme[0] : theme
    return {
      name,
